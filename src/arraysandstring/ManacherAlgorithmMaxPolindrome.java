...
public class ManacherAlgorithmMaxPolindrome {
	...
	public ManacherAlgorithmMaxPolindrome(String s) {
		this.s = s;
		t = preprocess(s);
		p = new int[t.length];
	...
	public static void main(String[] args) {
		...
		ManacherAlgorithmMaxPolindrome manacher = new ManacherAlgorithmMaxPolindrome(s);
